...
def apply_kafka_acl(principal, restype, name, operation, permission_type, resource_pattern_type):
    try:
        ...
        logging.info(f"Applied ACL: {principal} {permission_type} {operation} on {restype}:{name} with pattern {resource_pattern_type} in cluster ")
...
def delete_kafka_acl(principal, restype, name, operation, permission_type, resource_pattern_type):
    try:
        ...
        logging.info(f"Deleted ACL: {principal} {permission_type} {operation} on {restype}:{name} with pattern {resource_pattern_type} in cluster ")
    except Exception as e:
            ...
            for event in stream:
                ...
                if event_type == 'ADDED':
                    ...
                    if permission_type == 'ALLOW':
                        ...
                        delete_kafka_acl(principal, restype, name, operation, permission_type, resource_pattern_type)
                    apply_kafka_acl(principal, restype, name, operation, original_permission_type, resource_pattern_type)
